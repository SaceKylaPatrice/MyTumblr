...
$acc_username = "Kylapatrice";
$acc_password = "kylapatrice919";
$acc_fullname = "Kyla Patrice Soberano";
$acc_address = "Dawis, Gasan, Marinduque";

//check the currrent url for the redirections later
		...
		<div class="container">
		    ...
		    //this is the messaging
		      				if(isset($_REQUEST['notexist'])=== true){
		      					...
		      					echo "<div class='alert alert-warning role='alert'>You are still loged in. Please <a href='account.php'> click here </a>to proceed. </div>";
		      				}
