...
//check if the session variables are set or merong laman ang session variables or nagaexist sila
//to check if the acc is logged in or not
...
body {
    background: #654ea3;
    background: linear-gradient(to right,  #673ab7, #8993be, #232531);
    min-height: 100vh;
    overflow-x: hidden
}</style>
                                </head>
        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
                <div class="media align-items-end profile-head">
                    <div class="profile mr-3"><img src="images/myprofile.jpg" alt="..." width="150" class="rounded mb-2 img-thumbnail">

                        <a href="?logout" class="btn btn-outline-dark btn-sm btn-block">Signout</a>
            ...
            <div class="bg-light p-4 d-flex justify-content-end text-center">
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <h5 class="font-weight-bold mb-0 d-block">2.5K</h5><small class="text-muted"> <i class="fas fa-image mr-1"></i>Photos</small>
                    </li>
                    <li class="list-inline-item">
                        <h5 class="font-weight-bold mb-0 d-block">2.7M</h5><small class="text-muted"> <i class="fas fa-user mr-1"></i>Followers</small>
                    </li>
                    <li class="list-inline-item">
            ...
            <div class="px-4 py-3">
                ...
                <div class="p-4 rounded shadow-sm bg-light">
                    ...
                    <p class="font-italic mb-0">Draftsman</p>
                    <p class="font-italic mb-0">Animator</p>
            ...
            <div class="py-4 px-4">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <h5 class="mb-0">Photos</h5><a href="#" class="btn btn-link text-muted">See more...</a>
                </div>
                <div class="row">
